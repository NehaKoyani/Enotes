...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav me-auto mb-2 mb-lg-0">
			...
			<li class="nav-item"><a class="nav-link mr-2" href="addNotes.jsp"><i
					class="fa fa-plus-circle" aria-hidden="true"></i> Add Notes</a></li>
			<li class="nav-item"><a class="nav-link mr-2" href="showNotes.jsp"><i
	...
	<div class="modal fade" id="exampleModal" tabindex="-1"
		...
		<a href="login.jsp" class="btn btn-light my-2 my-sm-0 mr-2"
			...
			Login</a> <a href="registration.jsp" class="btn btn-light my-2 my-sm-0"
